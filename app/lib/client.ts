// Code generated by the Encore v1.46.9 client generator. DO NOT EDIT.
...
export namespace agents {
    ...
    export class ServiceClient {
        ...
        public async createAgent(params: AgentRequest): Promise<{
    data: AgentWithRelationsDTO
}> {
    ...
    data: AgentWithRelationsDTO
        ...
        public async createConfigProfile(params: ConfigProfileRequest): Promise<{
    data: ConfigProfile
}> {
            // Now make the actual call to the API
    ...
    data: ConfigProfile
        ...
        public async createInstructionSet(params: InstructionSetRequest): Promise<{
    data: InstructionSet
}> {
            // Now make the actual call to the API
    ...
    data: InstructionSet
        ...
        public async createModel(params: ModelRequest): Promise<{
    data: Model
}> {
            // Now make the actual call to the API
    ...
    data: Model
        ...
        public async createVoiceProfile(params: VoiceProfileRequest): Promise<{
    data: VoiceProfile
}> {
            // Now make the actual call to the API
    ...
    data: VoiceProfile
        ...
        public async getAgent(id: string): Promise<{
    data: AgentWithRelationsDTO
}> {
            // Now make the actual call to the API
...
export namespace auth {
    ...
    data: types.Organization
        ...
        public async getOrganizationsAttendedByUser(userId: string): Promise<{
    data: types.Organization[]
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/organizations/attended-by/${encodeURIComponent(userId)}`)
            return await resp.json() as {
    data: types.Organization[]
}
        }
    ...
    data: types.UserDto[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/users/by-ids`, JSON.stringify(params))
            return await resp.json() as {
    data: types.UserDto[]
}
        }
...
export namespace chatrooms {
    export interface ChatroomDto {
        ...
        messages: chats.ChatMessage[]
        agents: agents.AgentWithRelationsDTO[]
        name: string
...
export namespace chats {
    ...
    export class ServiceClient {
        ...
        public async createChatMessageReactions(params: ReactionRequest): Promise<{
    data: Reaction
}> {
            // Now make the actual call to the API
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "intellitask-yrr2-Generated-TS-Client (Encore/v1.46.9)";
        }
