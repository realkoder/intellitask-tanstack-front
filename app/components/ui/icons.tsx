import {
  ...
  export const Icons = {
    ...
    // course statuses
    CourseInProgress: StopwatchIcon,
    CourseCompleted: CheckCircledIcon,
    CoursePlanned: CalendarIcon,
    CourseNotPlanned: QuestionMarkCircledIcon,
