...
import j__default, { memo, useRef, useCallback, useEffect, createContext, forwardRef, useMemo, useState, isValidElement, useContext, Suspense, useLayoutEffect } from 'react';
import { v4 } from 'uuid';
import { AnimatePresence as AnimatePresence$1, motion as motion$1 } from 'framer-motion';
import { r, k as j, n as ne, y as ye$1, P, W, B, F, X as X$1, $, J as J$1, K, d as de$1, l as le, c as ce, p as pe$1, U, Y, Z } from './index-BPPryd0z.mjs';
...
function xe({ children: t, className: n, variant: r$1 = "default", value: a, onChange: p, onSubmit: c, loading: i, onStop: m, rows: C = 1, hasMessages: h = false, onAISelect: N, onMentionSelectionChange: s }) {
  const [k, S] = useState(0), d = useRef(null), f = W(), w = useRef(null), o = useRef(null), [x, z] = useState(/* @__PURE__ */ new Set()), [B, g] = useState(false), [E, y] = useState([Re]), [b, v] = useState(false), [I, $] = useState(false), [T, R] = useState(null), O = useRef([]), j = useRef(-1), [K, te] = useState(a || ""), [yn, qe] = useState(0), [Ne, ke] = useState({ top: 0, left: 10 }), [wn, Xe] = useState([]), Qe = (u) => {
    if (T !== null && b) {
      if (u.key === "Enter") {
        u.preventDefault();
        return;
    ...
    if (u.key === "Enter" && !u.shiftKey && c) {
      if (typeof K != "string" || K.trim().length === 0) return;
      if (T !== null) {
        u.preventDefault();
        return;
      }
  ...
  const Ie = (u) => {
    ...
    for (; A < u.length; ) {
      ...
      let W = u.indexOf(" ", P + 1);
      W === -1 && (W = u.length), M.push({ start: P, end: W, consumed: false }), A = W;
    }
    return M;
  }, Ye = (u) => {
    ...
    if (P.end === M.length) {
      const W = M.slice(P.start + 1, P.end);
      R(W), j.current = A.length - 1, b || (v(true), $(false)), s && s(true);
    ...
    if (T !== null && j.current >= 0) {
      ...
      if (A && o.current) {
        const P = K.substring(0, A.start), H = K.substring(A.end), W = P + `@${M.name}` + (H.startsWith(" ") ? "" : " ") + H;
        if (te(W), p && o.current) {
  ...
  return jsx(ve.Provider, { value: Te, children: jsxs("div", { className: "relative w-full", children: [b && jsx("div", { className: "fixed z-[999] shadow-lg", style: { top: `${Ne.top}px`, left: `${Ne.left}px` }, children: jsx(en, { selectedAgents: E.map((u) => ({ id: u.id, name: u.name, description: u.description })), onSelectAgents: (u) => {
    ...
    if (rn(u)) {
      ...
      if (M && (M.displayName === "ChatInputTextArea" || M === ee)) return an(u, { ref: (P) => {
        o.current = P;
        const H = u.ref;
        typeof H == "function" ? H(P) : H && "current" in H && (H.current = P);
...
function ee({ onSubmit: t, value: n, onChange: r$1, className: a, variant: p, ...c }) {
  var _a, _b;
  const i = useContext(ve), [m, C] = useState(""), h = (_a = n != null ? n : i.value) != null ? _a : m, N = r$1 != null ? r$1 : i.onChange, s = t != null ? t : i.onSubmit, k = (_b = i.rows) != null ? _b : 1, S = i.placeholder || "", d = i.hasMessages || false, f = useRef(null), w = p != null ? p : i.variant === "default" ? "unstyled" : "default", o = tn(h, k), x = useCallback((g) => {
    o && (typeof o == "function" ? o(g) : "current" in o && (o.current = g)), f.current = g;
  }, [o]);
  return jsxs("div", { className: "relative w-full", children: [jsx(B, { ref: x, ...c, value: h, onChange: (g) => {
  ...
  }, className: r("max-h-[400px] min-h-0 resize-none overflow-x-hidden", w === "unstyled" && "border-none focus-visible:ring-0 focus-visible:ring-offset-0 shadow-none", a), rows: k, placeholder: void 0 }), !h && jsx("div", { className: "absolute pointer-events-none top-0 left-0 right-0 bottom-0 flex items-center px-3 py-2", children: jsx(AnimatePresence$1, { mode: "wait", children: d ? jsx("span", { className: "text-muted-foreground truncate", children: S }) : jsx(motion$1.span, { initial: { opacity: 0, y: -5 }, animate: { opacity: 0.5, y: 0 }, exit: { opacity: 0, y: 5 }, transition: { duration: 0.3 }, className: "text-muted-foreground truncate", children: S }, S) }) })] });
}
...
const we = forwardRef(({ children: t, className: n, scrollButtonAlignment: r$1 = "right" }, a) => {
  const [p, c, i] = on();
  return jsxs(j, { className: "flex-1 relative", ref: a, children: [jsx("div", { ref: p, children: jsx("div", { className: r(n, "min-h-0 z-10"), children: t }) }), c && jsx(ln, { onClick: i, alignment: r$1, className: "absolute bottom-4 rounded-full shadow-lg hover:bg-secondary" })] });
});
we.displayName = "ChatMessageArea";
const de = "my-4 overflow-x-auto w-fit rounded-xl text-zinc-50 bg-zinc-900 dark:bg-zinc-900 border border-border p-4", ue = (t) => typeof t == "string" ? t : Array.isArray(t) ? t.map(ue).join("") : isValidElement(t) ? ue(t.props.children) : "", He = memo(async ({ children: t, className: n, language: r$1, ...a }) => {
...
He.displayName = "HighlightedPre";
const We = ({ children: t, language: n, className: r$1, ...a }) => jsx(Suspense, { fallback: jsx("pre", { ...a, className: r(de, r$1), children: jsx("code", { className: "whitespace-pre-wrap", children: t }) }), children: jsx(He, { language: n, ...a, children: t }) });
We.displayName = "CodeBlock";
const cn = { h1: ({ children: t, ...n }) => jsx("h1", { className: "mt-2 scroll-m-20 text-4xl font-bold", ...n, children: t }), h2: ({ children: t, ...n }) => jsx("h2", { className: "mt-8 scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight first:mt-0", ...n, children: t }), h3: ({ children: t, ...n }) => jsx("h3", { className: "mt-4 scroll-m-20 text-xl font-semibold tracking-tight", ...n, children: t }), h4: ({ children: t, ...n }) => jsx("h4", { className: "mt-4 scroll-m-20 text-lg font-semibold tracking-tight", ...n, children: t }), h5: ({ children: t, ...n }) => jsx("h5", { className: "mt-4 scroll-m-20 text-lg font-semibold tracking-tight", ...n, children: t }), h6: ({ children: t, ...n }) => jsx("h6", { className: "mt-4 scroll-m-20 text-base font-semibold tracking-tight", ...n, children: t }), p: ({ children: t, ...n }) => jsx("p", { className: "leading-6 [&:not(:first-child)]:mt-4", ...n, children: t }), strong: ({ children: t, ...n }) => jsx("span", { className: "font-semibold", ...n, children: t }), a: ({ children: t, ...n }) => jsx("a", { className: "font-medium underline underline-offset-4", target: "_blank", rel: "noreferrer", ...n, children: t }), ol: ({ children: t, ...n }) => jsx("ol", { className: "my-4 ml-6 list-decimal", ...n, children: t }), ul: ({ children: t, ...n }) => jsx("ul", { className: "my-4 ml-6 list-disc", ...n, children: t }), li: ({ children: t, ...n }) => jsx("li", { className: "mt-2", ...n, children: t }), blockquote: ({ children: t, ...n }) => jsx("blockquote", { className: "mt-4 border-l-2 pl-6 italic", ...n, children: t }), hr: (t) => jsx("hr", { className: "my-4 md:my-8", ...t }), table: ({ children: t, ...n }) => jsx("div", { className: "my-6 w-full overflow-y-auto", children: jsx("table", { className: "relative w-full overflow-hidden border-none text-sm", ...n, children: t }) }), tr: ({ children: t, ...n }) => jsx("tr", { className: "last:border-b-none m-0 border-b", ...n, children: t }), th: ({ children: t, ...n }) => jsx("th", { className: "px-4 py-2 text-left font-bold [&[align=center]]:text-center [&[align=right]]:text-right", ...n, children: t }), td: ({ children: t, ...n }) => jsx("td", { className: "px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right", ...n, children: t }), img: ({ alt: t, ...n }) => jsx("img", { className: "rounded-md", alt: t, ...n }), code: ({ children: t, node: n, className: r$1, ...a }) => {
  ...
  return p ? jsx(We, { language: p[1], className: r$1, ...a, children: t }) : jsx("code", { className: r("rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm", r$1), ...a, children: t });
}, pre: ({ children: t }) => jsx(Fragment, { children: t }) };
function dn(t) {
  return t ? marked.lexer(t).map((r) => r.raw) : [];
}
const De = memo(({ content: t, className: n }) => jsx(bs, { remarkPlugins: [vs], components: cn, className: n, children: t }), (t, n) => t.content === n.content);
...
const un = ({ children: t, url: n, className: r$1, width: a = 200, height: p = 125, isStatic: c = false, imageSrc: i = "" }) => {
  ...
  const [C, h] = j__default.useState(false), [N, s] = j__default.useState(false);
  ...
  return jsxs(Fragment, { children: [N ? jsx("div", { className: "hidden", children: jsx("img", { src: m, width: a, height: p, alt: "hidden image" }) }) : null, jsxs(_t.Root, { openDelay: 50, closeDelay: 100, onOpenChange: (w) => {
    h(w);
  }, children: [jsx(_t.Trigger, { onMouseMove: f, className: r("text-black dark:text-white", r$1), href: n, target: "_blank", rel: "noopener noreferrer", children: t }), jsx(_t.Content, { className: "[transform-origin:var(--radix-hover-card-content-transform-origin)]", side: "top", align: "center", sideOffset: 10, children: jsx(AnimatePresence, { children: C && jsx(motion.div, { initial: { opacity: 0, y: 20, scale: 0.6 }, animate: { opacity: 1, y: 0, scale: 1, transition: { type: "spring", stiffness: 260, damping: 20 } }, exit: { opacity: 0, y: 20, scale: 0.6 }, className: "shadow-xl rounded-xl", style: { x: d }, children: jsx(Link, { to: n, className: "block p-1 bg-white border-2 border-transparent shadow rounded-xl hover:border-neutral-200 dark:hover:border-neutral-800", style: { fontSize: 0 }, target: "_blank", rel: "noopener noreferrer", children: jsx("img", { src: c ? i : m, width: a, height: p, className: "rounded-lg", alt: "preview image" }) }) }) }) })] })] });
}, mn = cva("flex gap-4 w-full", { variants: { variant: { default: "", bubble: "", full: "p-5" }, type: { incoming: "justify-start mr-auto", outgoing: "justify-end ml-auto" } }, compoundVariants: [{ variant: "full", type: "outgoing", className: "bg-muted" }, { variant: "full", type: "incoming", className: "bg-background" }], defaultVariants: { variant: "default", type: "incoming" } }), Ge = j__default.createContext(null), Ue = () => j__default.useContext(Ge), he = j__default.forwardRef(({ className: t, variant: n = "default", type: r$1 = "incoming", id: a, children: p, ...c }, i) => jsx(Ge.Provider, { value: { variant: n, type: r$1, id: a }, children: jsx("div", { ref: i, className: r(mn({ variant: n, type: r$1, className: t })), ...c, children: p }) }));
he.displayName = "ChatMessage";
const hn = cva("w-8 h-8 flex items-center rounded-full justify-center ring-1 shrink-0 bg-transparent overflow-hidden", { variants: { type: { incoming: "ring-border", outgoing: "ring-muted-foreground/30" } }, defaultVariants: { type: "incoming" } }), fe = j__default.forwardRef(({ className: t, icon: n, imageSrc: r$1, ...a }, p) => {
  var _a, _b;
...
function gn({ onReact: t, onReply: n, onEdit: r, className: a, messageData: p }) {
  ...
  }, []), jsxs("div", { className: `relative w-[7.5rem] ${a}`, children: [jsxs("div", { className: "bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full shadow-sm flex items-center px-1 relative", children: [jsxs(U, { children: [jsx(Y, { asChild: true, children: jsx("button", { ref: C, className: "p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400", onClick: () => i(!c), "aria-label": "Add reaction", children: jsx(Smile, { className: "h-5 w-5" }) }) }), jsx(Z, { sideOffset: 8, children: "Add reaction" })] }), jsxs(U, { children: [jsx(Y, { asChild: true, children: jsx("button", { className: "p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400", onClick: n, "aria-label": "Reply", children: jsx(MessageSquare, { className: "h-5 w-5" }) }) }), jsx(Z, { sideOffset: 8, children: "Reply" })] }), jsxs(U, { children: [jsx(Y, { asChild: true, children: jsx("button", { className: "p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400", onClick: r, "aria-label": "Edit", children: jsx(Edit, { className: "h-5 w-5" }) }) }), jsx(Z, { sideOffset: 8, children: "Edit" })] })] }), c && jsx("div", { ref: m, className: "absolute right-0 top-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md p-2 z-10", children: jsx("div", { className: "flex gap-1", children: h.map((s, k) => jsx("button", { onClick: () => N(s), className: "hover:bg-gray-100 dark:hover:bg-gray-700 p-2 rounded-full text-lg", children: s }, k)) }) })] });
}
const oe = ({ messageData: t, isLastChunk: n = true, userID: r, userImage: a, onReply: p, chatroom: c }) => {
  var _a, _b;
  const [i, m] = useState(false), C = t.data.senderId === r, [h] = useAtom(ne), N = (h == null ? void 0 : h.members.length) !== 1;
  if (!C) {
  ...
  const [c, i] = useState(false), [m, C] = useState(""), [h, N] = useState(false), [s] = useAtom(ne), k = t.data.id || t.identifier, S = useMemo(() => p.filter((g) => g.data.parentMessageId === k).map((g) => g.data), [p, k]), d = S.length > 0, w = !!!t.data.parentMessageId && (d || t.data.isThreadStarter), o = async () => {
    if (!(!m.trim() || !s || h)) {
      N(true);
      try {
        const g = k, E = v4();
...
function xn({ className: t, ...n }) {
  const { userId: r, chatroom: a } = Be.useRouteContext(), { chatroomId: p } = Be.useParams(), c = useRef(void 0), [i, m] = useState(false), [C, h] = useState([]), [N, s] = useState(""), k = useSetAtom(ne), S = useRef(null), d = async (o) => {
    if (!(i || !N.trim() && !o)) try {
...
//# sourceMappingURL=_chatroomId-CyAyocr2.mjs.map
